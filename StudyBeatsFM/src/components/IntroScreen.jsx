...
const Hero = () => {
    return(
        ...
        <div className="titleContainer">
          ...
          <h1 className="tracking-in-expand-fwd">Music for Chris</h1>
          <h3 className="subTitle"> Một trang nghe nhạc dành riêng cho anh </h3>
          ...
          <div class="wrap">
            <Link to="/music">
                <button class="button">Bấm dô nghe nè</button>
            </Link>         
          </div>
        </div>
        <ReactPlayer 
